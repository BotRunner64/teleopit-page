...
All published videos are silent H.264 MP4 files with `yuv420p` pixel format and the MP4 index moved to the start of the file (`faststart`). The long loco-manipulation clips are 720p web derivatives. Original footage remains in the ignored `teleopit_demo/` directory.
